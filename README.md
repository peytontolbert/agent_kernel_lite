...
```text
https://github.com/peytontolbert/agent_kernel_lite/releases/tag/v4
```
...
No extensions are default-installed in v4. The app shows available official
...
before it can act. Image Generation is kept out of the official v4 catalog
...
pass/fail. The v4 release includes:

```text
agent-kernel-lite-verifier-v4.tar.gz
verifier-SHA256SUMS
```
...
The v4 GitHub Release publishes individual shell assets and a tarball:
...
catalog.json
computer_use.json
agent-kernel-lite-v4-shell.tar.gz
SHA256SUMS
agent-kernel-lite-verifier-v4.tar.gz
verifier-SHA256SUMS
```
