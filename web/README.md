...
- browser-installed extensions. The v4 shell ships with no default-installed
...
The v4 app install includes no default-installed extensions. The Extensions menu
...
For v4, the official catalog exposes Computer Use only. Image Generation remains
